...
VS_OUTPUT vs_recolectado(VS_INPUT Input)
{
    ...
    //Output.RealPos = float4(10 * sin(time*2) * Input.Position.x, 10 * sin(time*2) * Input.Position.y, 10 * sin(time*2) * Input.Position.z, 1);
    Output.RealPos = float4(time*2 * Input.Position.x, Input.Position.y, time*2  * Input.Position.z, 1);
